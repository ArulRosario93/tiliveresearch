...
const ReportLabelsContainer = ({ text, data, sample, selected, buy, showContentOnly, subText, handleClick }) => {
            ...
            {buy ? (
                <div className="ReportLabelsContainerBuyLayer">
                    ...
                    <div className="ReportLabelsContainerBuyLayerItem">
                        ...
                        <label htmlFor="single">Single User License (${data?.reportSingleUserPrice || '4999'})</label>
                    </div>
                    <div className="ReportLabelsContainerBuyLayerItem">
                        <input type="checkbox" name="Corporate" id="corp" />
                        <label htmlFor="corp">Corporate License (${data?.reportCorporatePrice || '5999'})</label>
                    </div>
